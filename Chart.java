...
public class Chart extends ApplicationFrame
{
	static long re,un;
	static String title;
  public Chart(String paramString,long r,long u)
  {
    super(paramString);
	re = r;
	un = u;
  ...
  private static CategoryDataset createDataset(){
	  ...
	  localDefaultCategoryDataset.addValue(re,"Redundancy Detection","Redundancy Detection");
	  localDefaultCategoryDataset.addValue(un,"Unique Data","Unique Data");
...
public void windowClosing(WindowEvent we){
  ...
  {
    JFreeChart localJFreeChart = ChartFactory.createBarChart(title, "Detection", "Value", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
  ...
  public static JPanel createDemoPanel()
  {
	...
	try{
	java.io.File f=new java.io.File("C:/pie.jpg");
	ChartUtilities.saveChartAsJPEG(f,localJFreeChart,400,300);
	}catch(Exception e){
		e.printStackTrace();
	}
